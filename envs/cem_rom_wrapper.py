...
class CEMROMWrapper(NESEnv):
    """An OpenAI Gym interface to the NES game MEGAMAN2"""

    def __init__(self, rom_path):
        """Initialize a new MEGAMAN2 environment."""
        super(CEMROMWrapper, self).__init__(rom_path)
    ...
    def _did_step(self, done):
        ...
        self.num_lives = self.ram[166]
        self.megaman_enrg = self.ram[106]
        self.bonus_ball = self.ram[174]
    ...
    def _get_reward(self):
        ...
        weighted_score = (self.score * 0.001)
        weighted_num_lives = self.num_lives*10000
        weighted_megaman_enrg = self.megaman_enrg*100
        weighted_bonus = self.bonus_ball*100
        #return max(screen_dist, score)
        return (weighted_score + weighted_num_lives + weighted_megaman_enrg + weighted_bonus)/1000
...
__all__ = [CEMROMWrapper.__name__]
